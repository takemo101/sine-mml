...
# MIDI (optional, enabled by default via 'midi-output' feature)
...
| `midi-output` | MIDIストリーミング機能 | ✅ | MIDIデバイス出力 |

**Feature定義例（Cargo.toml）**:
...
| 2026-01-14 | 1.1.0 | BASIC-CLI-006対応: midir依存追加、midi-output feature追加 | detailed-design-writer |
| 2026-01-14 | 1.2.0 | Linux CI環境向けlibasound2-devインストール手順追加、Feature定義例追加 | detailed-design-writer |
